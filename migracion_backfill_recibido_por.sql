...
UPDATE "ventas" SET "recibido_por" = 'Juan'    WHERE "recibido_por" IS NULL AND "metodo" IN ('Juan Nequi', 'Juan Bancolombia');
...
UPDATE "ordenes_maquila" SET "recibido_por" = 'Juan'    WHERE "recibido_por" IS NULL AND "metodo" IN ('Juan Nequi', 'Juan Bancolombia');
